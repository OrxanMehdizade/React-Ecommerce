  ...
  return (
    <>
      <div className="w-full h-screen flex items-center justify-center">
        <form class="max-w-md mx-auto p-4 bg-white border border-gray-200 rounded-lg shadow sm:p-6 md:p-8">
          ...
          <div className="relative z-0 w-full mb-5 group flex items-center">
            <input
              onChange={(e) => handleInput("isAdmin", e.target.checked)}
              type="checkbox"
              id="isAdmin"
              className="mr-2"
            />
